...
const ThemeSettings = () => {
  ...
  LicenseInfo.setLicenseKey('4f385835cbd2ec628a3248e00fded6a0Tz02MTYzMixFPTE3MDk5ODM2NDEwMTcsUz1wcm8sTE09c3Vic2NyaXB0aW9uLEtWPTI=');
  ...
  const curThemeName = localStorage.getItem("appTheme") || "BlackLightTheme";
        ...
        >
          ...
          >
            <ThemeToggleWrapper>
              ...
              <Tooltip placement="left" title="Black Light" arrow>
                  <ButtonWrapper
                    className={theme === "BlackLightTheme" ? "active" : ""}
                    onClick={() => {
                      changeTheme("BlackLightTheme");
                    }}
                  >
                    ...
                    <ColorSchemeWrapper className="colorSchemeWrapper blackLight">
