...
exports.midContentData= [
    {
      ...
      listContent:[
       ...
       altText:'Customer Satisfaction Analysis',
    ...
    
    {
      ...
      listContent:[
       ...
       altText:'net promoter score analysis',
...

    {
      ...
      listContent:[
       ...
       altText:'Predictive Churn Analysis',
       bannerdirection:'right',
    },
  ]
  ...
  exports.midContentDatamar= [
    ...
    
    {
      ...
      listContent:[
       ...
       altText:'Customer Behaviour Insights',
       bannerdirection:'left',
    },
  ...
  exports.midContentDatamarIn= [
    {
      ...
      listContent:[
       ...
       altText:'Market Insights Analysis', 
       bannerdirection:'right',
    }, 
    {
      ...
      listContent:[{
       ...
       altText:'predictive Trend Analysis', 
       bannerdirection:'left',
    },
