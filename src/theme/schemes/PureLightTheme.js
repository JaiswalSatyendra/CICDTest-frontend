...
const colors = {
  gradients: {
    ...
    blue5a: 'linear-gradient(135deg, #210ba1 10%, #7a5efe 100%)',
    skyBlue: 'linear-gradient(135deg, #6ffae5 10%, #35a6e8 100%)',
    orange1: 'linear-gradient(135deg, #FCCF31 0%, #F55555 100%)',
    orange2: 'linear-gradient(135deg, #FFD3A5 0%, #FD6585 100%)',
    orange3: 'linear-gradient(120deg, #f6d365 0%, #fda085 100%)',
    orange4: 'linear-gradient(-20deg, #f01663 0%, #fcc2ad 100%)',
    purple1: 'linear-gradient(135deg, #43CBFF 0%, #9708CC 100%)',
    purple3: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
    yellowOrange: 'linear-gradient(40deg, #ff3299 0%, #fae638 100%)',
...
export const PureLightTheme = createTheme({
  ...
  colors: {
    gradients: {
      ...
      blue4a: colors.gradients.blue4a,
      blue5: colors.gradients.blue5,
      blue5a: colors.gradients.blue5a,
      skyBlue: colors.gradients.skyBlue,
      orange1: colors.gradients.orange1,
      orange2: colors.gradients.orange2,
      orange3: colors.gradients.orange3,
      orange4: colors.gradients.orange4,
