...
const Results = ({ datasets, fetchDatasets, getDataAnalysis, getDataPredict }) => {
  ...
  useEffect(async () => {
    setGridDataForGrid({
      columns: new Array(
        { field: "datasetName", headerName: "Dataset Name", sortable: true, width: 250, },
        { field: "crmType", headerName: "Type", sortable: true, width: 150, },
        { field: "objectLabel", headerName: "Object Label", sortable: true, width: 200, },
        { field: "createdOn", headerName: "Created Time", sortable: true, width: 200, },
        {
