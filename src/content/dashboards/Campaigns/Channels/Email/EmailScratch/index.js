...
const DashBoardEmailEditor = () => {
  ...
  const [isScratch, setIsScratch] = useState("fromscratch");
  const [btnstyle, setbtnstyle] = useState("child1");
  const [btnstyle2, setbtnstyle2] = useState("child2");
