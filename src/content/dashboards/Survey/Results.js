...
const Results = ({ datasets, fetchDatasets, getDataAnalysis, getDataPredict }) => {
  ...
  useEffect(async () => {
    setGridDataForGrid({
      columns: new Array(
        { field: "projectid", headerName: "ProjectId", sortable: true, width: 250, },
        { field: "analysisName", headerName: "Analysis Name", sortable: true, width: 160, },
        { field: "templateName", headerName: "Template Name", sortable: true, width: 200, },
        { field: "createdon", headerName: "Last Run Time", sortable: true, width: 190, },
        {
                ...
                <Table>
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell>{t("Analysis Name")}</TableCell>
